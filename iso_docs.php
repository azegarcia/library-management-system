			...
			<div class="span12">	
						...
						<!--  -->
                                    ...
                                    <li  ><a href="documents.php">All</a></li>						
										...
										<li class="active" ><a href="iso_docs.php">ISO Documents</a></li>
									</ul>
						<!--  -->
						<center class="title">
						<h1>New Books</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($conn,"select * from book where status = 'ISO Documents'")or die(mysqli_error());
