			...
			<div class="span12">	
						...
						<!--  -->
									...
									<li  ><a href="documents.php">All</a></li>						
										...
										<li><a href="cdop.php">Collection Development, Organization and Preservation</a></li>
										<li><a href="services_utilization.php">Services and Utilization</a></li>
										<li class="active" ><a href="physical_sf.php">Physical Set-up and Facilities</a></li>
						...
						<h1>New Books</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($conn,"select * from book where status = 'Physical Set-up and Facilities'")or die(mysqli_error());
